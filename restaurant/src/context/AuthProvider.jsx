...
// import { apiGet } from "../api/api"; // Assuming the path to your API utility is correct

// // This component is the default export.
// export default function AuthProvider({ children }) {
//   const [user, setUser] = useState(null);

//   /**
//    * Function to check the current user session.
//    * Updates the `user` state based on the API response.
//    */
//   async function loadUser() {
//     try {
//       // Assuming apiGet returns an object with a truthy 'userid' if authenticated
...
//       }
//     } catch (error) {
//       // Clear user on any API or network error
//       console.error("Error loading user:", error);
//       setUser(null);
//     }
//   }

//   // Load the user when the component mounts (on initial app load)
//   useEffect(() => {
//     loadUser();
//   }, []);

//   // The value exposed to all consuming components
//   const contextValue = { 
//     user, 
//     setUser, 
//     loadUser 
...
//     setLoading(true);
//     try {
//       const res = await apiGet("whoami/");   // expects { userid, role, username } or {}
//       if (res && res.userid) setUser(res);
//       else setUser(null);
//     } catch (err) {
...
//   const contextValue = { user, setUser, loadUser, loading };
